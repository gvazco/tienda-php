...
require_once "../app/Http/Controllers/SlideController.php";
...
class AjaxSlide{
	...
	public function ajaxCrearSlide(){
		...
		$respuesta = SlideController::ctrCrearSlide($datos);
	...
	public function ajaxOrdenSlide(){
		...
		$respuesta = SlideController::ctrActualizarOrdenSlide($datos);

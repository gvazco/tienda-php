...
class ControladorUsuarios{
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('ventas@techosymantenimientos.com.mx', 'Mevasa Comercializadora');

					$mail->addReplyTo('ventas@techosymantenimientos.com.mx', 'Mevasa Comercializadora');
					...
					$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<center>
							...
							<img style="padding:20px; width:10%" src="http://www.techosymantenimientos.com.mx/tienda/logo.png">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<img style="padding:20px; width:15%" src="http://www.techosymantenimientos.com.mx/tienda/icon-email.png">
					...
					if($respuesta2  == "ok"){
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<center>
									...
									<img style="padding:20px; width:10%" src="http://www.techosymantenimientos.com.mx/logo.png">
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<img style="padding:20px; width:15%" src="http://www.techosymantenimientos.com.mx/icon-pass.png">
	...
	public function ctrActualizarComentario(){
		...
		if(isset($_POST["idComentario"])){
			...
			if(preg_match('/^[,\\.\\a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["comentarioPerfil"])){

				if($_POST["comentarioPerfil"] != ""){

					$tabla = "comentarios";

					$datos = array("id"=>$_POST["idComentario"],
								   "calificacion"=>$_POST["puntaje"],
								   "contenido_opinion"=>$_POST["comentarioPerfil"]);
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->addAddress("ventas@techosymantenimientos.com.mx");

					$mail->msgHTML('

						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">

						<center><img style="padding:20px; width:10%" src="http://www.techosymantenimientos.com.mx/tienda/logo.png"></center>

						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">

							<center>

							<img style="padding-top:20px; width:15%" src="http://www.techosymantenimientos.com.mx/tienda/icon-email.png">

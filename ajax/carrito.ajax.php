...
class AjaxCarrito{ 
	...
	public function ajaxTraerComercioMercado(){
...
if(isset($_POST["divisa"])){
	...
	for($i = 0; $i < count($idProductos); $i ++){
		...
		$divisa = file_get_contents("http://free.currconv.com/api/v7/convert?q=MXN_".$_POST["divisa"]."&compact=ultra&apiKey=a01ebaf9a1c69eb4ff79");
...
if(isset($_POST["metodoPago"]) && $_POST["metodoPago"] == "mercado"){
	...
	for($i = 0; $i < count($idProductos); $i ++){
		...
		$conversion = number_format($jsonDivisa["MXN_".$_POST["divisaMercado"]],2);
	...
	$mercado = new AjaxCarrito();
	$mercado -> ajaxTraerComercioMercado();

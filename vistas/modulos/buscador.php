					...
					if($value["estado"] != 0){
						...
						if($value["tipo"] == "virtual" && $value["precio"] != 0){
							...
							if($value["oferta"] != 0){
								...
								echo '<a href="'.$value["rutaAfiliado"].'"><button type="button" class="btn btn-default btn-xs solicitarCotizacion border"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precioOferta"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Adquirir Ahora">
								...
								echo '<a href="'.$value["rutaAfiliado"].'"><button type="button" class="btn btn-default btn-xs solicitarCotizacion border"  idProducto="'.$value["id"].'" imagen="'.$servidor.$value["portada"].'" titulo="'.$value["titulo"].'" precio="'.$value["precio"].'" tipo="'.$value["tipo"].'" peso="'.$value["peso"].'" data-toggle="tooltip" title="Adquirir Ahora">

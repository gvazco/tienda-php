...
<div class="container-fluid well well-sm col-12 col-xs-12 fondoBreadcrumb text-uppercase pl-5">
...
<div class="container-fluid mt-3">
	...
	<div class="container">
		...
		<ul class="nav nav-tabs">
					...
					if(!$compras){
						...
						foreach ($compras as $key => $value1) {
							...
							foreach ($productos as $key => $value2) {
								...
								echo '<div class="card col-12 border-0 mt-2 mb-4 ml-lg-0 p-3" style="background:#eee">
								...
								<div class="row">
									...
									<div class="col-md-8 col-sm-8 col-xs-12 ml-xs-2 row">

									<h1 class="perfilTitulo"><small>'.$value2["titulo"].'</small></h1>

									<p class="perfilTitular" style="text-align:justify;">'.$value2["titular"].'</p>
								...
								if($value2["tipo"] == "virtual"){
									...
									if($value1["envio"] == 0){
										...
										echo '<div class="progress barra">

										<div class="progress-bar bg-success" role="progressbar" style="width:33.33%">
										<i class="fas fa-check"></i> Despachado
										</div>

										<div class="progress-bar" role="progressbar" style="width:33.33%">
										<i class="fas fa-clock-o"></i> Enviando
										</div>

										<div class="progress-bar bg-secondary" role="progressbar" style="width:33.33%">
										<i class="fas fa-clock-o"></i> Entregado
										</div>
									...
									if($value1["envio"] == 1){
										...
										<div class="progress-bar bg-success" role="progressbar" style="width:33.33%">
										<i class="fas fa-check"></i> Enviando
										</div>
									...
									if($value1["envio"] == 2){
										...
										<div class="progress-bar bg-default" role="progressbar" style="width:33.33%">
										<i class="fas fa-check"></i> Enviando
										</div>
			...
			<div id="deseos" class="tab-pane fade mt-2">
				...
				if(!$deseos){
					...
					foreach ($deseos as $key => $value1) {
						...
						foreach ($productos as $key => $value2) {
							...
							echo '<li class="card col-12 col-lg-3 col-md-6 border-0 mt-2 mb-4 ml-lg-0 p-3" style="background:#eee">

							<figure>

							<a href="'.$url.$value2["ruta"].'" class="pixelProducto">

							<img src="'.$servidor.$value2["portada"].'" class="img-responsive" width="100%">

							</a>

							</figure>

							<div class="card-body border-1 shadow-sm p-4 p-lg-3 p-xl-2 bg-white">
							...
							<div class="col-xs-6 mt-1 precio" style="text-align:center;">';

							if($value2["precio"] == 0){

								echo '<h2><small>GRATIS</small></h2>';

							}else if($value2["precio"] == 1){
								...
								if($value2["oferta"] != 0){
									...
									<strong class="oferta">MXN $'.$value2["precio"].'</strong>
									...
									echo '<h2><small>MXN $'.$value2["precio"].'</small></h2>';
							...
							<div class="col-xs-6 pt-0 enlaces" style="text-align:center;">

							<div class="btn-group pull-right">

							<button type="button" class="btn btn-danger btn-xs quitarDeseo border" idDeseo="'.$value1["id"].'" data-toggle="tooltip" title="Quitar de mi lista de deseos">
			...
			<div id="perfil" class="tab-pane fade">
				...
				<div class="row">
					...
					<button class="btn btn-danger btn-md pull-right m-3" id="eliminarUsuario">Eliminar cuenta</button>
		...
		<div class="modal-body modalTitulo">
			...
			<form method="post" onsubmit="return validarComentario()">
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="5" id="comentarioPerfil" name="comentarioPerfil" maxlength="300" required></textarea>

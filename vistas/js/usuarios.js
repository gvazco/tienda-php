...
=============================================*/
 ...
 function validarComentario(){
 	...
 	var comentario = $("#comentarioPerfil").val();
 	...
 	if(comentario != ""){
 		...
 		if(!expresion.test(comentario)){
 			...
 			$("#comentarioPerfil").parent().before('<div class="alert alert-danger"><strong>ERROR:</strong> No se permiten caracteres especiales como por ejemplo !$%&/?¡¿[]*</div>');
 		...
 		$("#comentarioPerfil").parent().before('<div class="alert alert-warning"><strong>ERROR:</strong> Campo obligatorio</div>');

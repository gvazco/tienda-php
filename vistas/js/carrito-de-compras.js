			...
			$.ajax({
				...
				success: function(respuesta){
					...
					$(".cuerpoCarrito").append(
						...
						'<div class="row col-xs-12 card-item itemCarrito p-2" style="background:#eee">'+
							...
							'<div class="col-md-1 col-xs-12">'+
								...
								'<center>'+
									...
									'<button class="btn btn-default mt-4 backColor quitarItemCarrito" idProducto="'+item.idProducto+'" peso="'+item.peso+'">'+
							...
							'<div class="col-md-2 col-xs-12">'+
								...
								'<p class="precioCarritoCompra ml-2 text-center">MXN $<span>'+precio+'</span></p>'+
							...
							'<div class="col-md-2 col-xs-8">'+
								...
								'<div class="col-xs-6">'+
									...
									'<center>'+
										...
										'<input type="number" class="form-control cantidadItem ml-2" style="text-align:center;" min="1" value="'+item.cantidad+'" tipo="'+item.tipo+'" precio="'+precio+'" idProducto="'+item.idProducto+'" item="'+index+'">'+	
							...
							'<div class="col-md-2 col-xs-4 text-center">'+
								...
								'<p class="subTotal'+index+' subtotales ml-2 pb-3">'+
...
$("#cambiarDivisa").change(function(){
	...
	if($("#seleccionarPais").val() == ""){
		...
		$("#cambiarDivisa").after('<div class="alert alert-danger">No ha seleccionado la zona de envío.</div>');
...
$(".btnPagar").click(function(){
	...
	if(tipo == "fisico" && $("#seleccionarPais").val() == ""){
		...
		$(".btnPagar").after('<div class="alert alert-warning">No ha seleccionado la zona de envío</div>');
...
/*=============================================
/*=============================================
BOTÓN PAGAR MERCADO PAGO
=============================================*/

// function pagarConMercado(){

// 	if($("#seleccionarPais").val() == ""){

// 		$(".formMercado").after('<div class="alert alert-warning">No ha seleccionado el país de envío</div>');
		
// 		$(".formMercado input[name='Submit']").attr("type","button");
...
// 	var datos = new FormData();
// 	datos.append("metodoPago", "mercado");
// 	datos.append("cantidadArray",cantidadArray);
// 	datos.append("valorItemArray",valorItemArray);
// 	datos.append("idProductoArray",idProductoArray);
// 	datos.append("divisaMercado", divisa);
